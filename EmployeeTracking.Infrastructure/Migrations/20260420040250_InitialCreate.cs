        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyOvertimeThresholdHours = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    WeeklyOvertimeThresholdHours = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OvertimeMultiplier = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    HasPaidBreaks = table.Column<bool>(type: "bit", nullable: false),
                    PaidBreakMinutes = table.Column<int>(type: "int", nullable: false),
                    UnpaidBreakMinutes = table.Column<int>(type: "int", nullable: false),
                    PTOAccrualRatePerPayPeriod = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MaxPTOBalanceHours = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PlannedStart = table.Column<TimeOnly>(type: "time", nullable: false),
                    PlannedEnd = table.Column<TimeOnly>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectedFromId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalRegularHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    TotalOvertimeHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    TotalPTOHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    TotalUnpaidHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PremiumMultiplier = table.Column<decimal>(type: "decimal(4,2)", precision: 4, scale: 2, nullable: false),
                    HasDoubleTime = table.Column<bool>(type: "bit", nullable: false),
                    DoubleTimeDailyThreshold = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OvertimeRules_AttendancePolicies_AttendancePolicyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BreakStart = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    BreakEnd = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PTOHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    UnpaidHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    TotalPayableHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    HasExceptions = table.Column<bool>(type: "bit", nullable: false),
                    ExceptionNotes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollReports_PayPeriods_PayPeriodId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccruedHours = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PTOBalances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PTOBalances_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateOnly>(type: "date", nullable: false),
                    EndDate = table.Column<DateOnly>(type: "date", nullable: false),
                    HoursRequested = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PTORequests_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OvertimeRules_AttendancePolicyId",
                table: "OvertimeRules",
                column: "AttendancePolicyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollReports_PayPeriodId",
                table: "PayrollReports",
                column: "PayPeriodId");

            migrationBuilder.CreateIndex(
                name: "IX_PTOBalances_EmployeeId",
                table: "PTOBalances",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_PTORequests_EmployeeId",
                table: "PTORequests",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timesheets_EmployeeId_PayPeriodId",
                table: "Timesheets",
